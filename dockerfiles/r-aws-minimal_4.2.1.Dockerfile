...
LABEL org.opencontainers.image.description="r-ver plus R packages `renv` & `units` and system libraries `curl`, `git`, `jq`, `libssl-dev` & `libsasl2-dev`"
LABEL org.opencontainers.image.licenses="MIT + file LICENSE"
LABEL org.opencontainers.image.revision="afbe272ec74d816b1359785237a24e62480c777f"
